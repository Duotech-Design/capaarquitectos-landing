...
const Home = () => {
  ...
  return (
    <section
      id="home"
      className="relative mx-auto px-2 sm:px-6 lg:px-8 min-h-screen h-[100lvh] overflow-hidden bg-white"
    >
        ...
        <div key={index}>
          {index === previousImageIndex && (
            <HomeAsset
              ...
              alt={custom.alt}
              className="absolute inset-0 object-cover w-full h-[100lvh] object-center z-0"
            />
          )}
          {index === currentImageIndex && (
            <HomeAsset
              ...
              onClick={handleImageClick}
              alt={custom.alt}
              className={`absolute inset-0 object-cover w-full h-[100lvh] object-center z-0 transition-transform duration-3000 ${
