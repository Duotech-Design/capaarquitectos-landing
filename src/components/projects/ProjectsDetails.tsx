...
const ProjectsDetails = () => {
  ...
  return (
    <section className="flex flex-col mx-auto px-2 sm:px-6 lg:px-8 min-h-screen max-w-[2000px]">
      ...
      <h3 className="mt-28 pb-6 md:pb-1 lg:text-2xl text-sm drop-shadow-sm text-black flex justify-between items-center gap-x-3 w-[400px]"> {/* Cambiado de w-[300px] a w-[400px] */}
  <svg
